      ...
      <div className="min-h-screen flex items-center justify-center">
        <div className="max-w-md mx-auto px-6 text-center animate-scale-in">
          ...
          <p className="text-slate-400 mb-8 text-lg">
            You need to sign in with GitHub to publish plugins
          </p>
          <a
          ...
          >
            ...
            <div className="relative inline-flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-purple-600 to-pink-600 rounded-xl text-white font-semibold shadow-lg shadow-purple-500/30 hover:shadow-purple-500/50 transition-all">
        ...
        <div className="p-6 bg-gradient-to-br from-cyan-500/10 to-violet-500/10 border border-cyan-500/20 rounded-2xl">
          ...
          <div className="space-y-3 text-sm text-slate-300">
            <div className="flex gap-3">
              ...
              <div>
                <strong>In ZAL:</strong> Run <code className="px-2 py-1 bg-black/30 rounded text-cyan-400">zal</code> and type <code className="px-2 py-1 bg-black/30 rounded text-cyan-400">/plugins</code>
              </div>
            </div>
            <div className="flex gap-3">
