    ...
    <div className="min-h-screen bg-[#03030d] text-slate-200 font-sans">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4 bg-[#03030d]/85 backdrop-blur-xl border-b border-cyan-500/8">
        <div className="flex items-center gap-3">
          ...
          <span className="font-bold text-white tracking-tight">ZAL</span>
        ...
        <div className="flex items-center gap-4">
          ...
          <a href="https://github.com/ubercodex/zalcli/issues" target="_blank" rel="noopener noreferrer" className="text-sm text-slate-400 hover:text-cyan-400 transition-colors hidden sm:block">Issues</a>
        ...
        <div className="relative max-w-6xl mx-auto w-full grid lg:grid-cols-2 gap-16 items-center">
          <div className="animate-fade-up">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black leading-none tracking-tight mb-6">
              ...
              <span className="text-white">for ZAL</span>
            </h1>

            <p className="text-slate-400 text-lg leading-relaxed mb-8 max-w-lg">
              Discover and share custom AI tools for ZAL. Describe what you need, AI generates the code, and you can publish it here for everyone.
            </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-bold text-white">ZAL</div>
            ...
            <div className="flex items-center gap-6 text-sm text-slate-400">
              ...
              <a href="https://github.com/ubercodex/zalcli" target="_blank" rel="noopener noreferrer" className="hover:text-cyan-400 transition-colors">GitHub</a>
              <a href="https://github.com/ubercodex/zalcli/issues" target="_blank" rel="noopener noreferrer" className="hover:text-cyan-400 transition-colors">Issues</a>
              <a href="#contact" className="hover:text-cyan-400 transition-colors">Contact</a>
            </div>
            <div className="flex flex-col gap-1 text-xs text-slate-600 text-right">
              <div>© 2026 ZAL. MIT License.</div>
            </div>
          </div>
        </div>
      </footer>
